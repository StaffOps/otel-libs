module github.com/staffops/staffops-otel-libs/go/example/go-process
...
require (
	github.com/staffops/staffops-otel-libs/go v0.0.0
...
replace github.com/staffops/staffops-otel-libs/go => ../../
